...
import { Badge, type BadgeTone, toneForSeverity, toneForStatus } from "./components/Badge";
...
function findingTotal(report: DriftReport | null): number {
  if (!report) {
    return 0;
  }
